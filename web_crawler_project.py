...
# import requests to send requests from local PC to Amazon website
# import to send result to a .csv file + record time
import requests, csv, time

# mark script's starting time
start = time.time()
